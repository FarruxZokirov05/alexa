<?php
          ...
          if($result->num_rows > 0){
            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
              ...
              $text_uz_ser = $row['text_uz'];
              $title_en_ser = $row['title_en'];
              $text_en_ser = $row['text_en'];
                        }} 
          ...
          try{
            ...
            if(isset($_POST['add'])){
                      $smtp = $connection->prepare("INSERT INTO service (icon, title_uz, title_en, text_uz, text_en ) VALUES ( :icon, :title_uz, :title_en, :text_uz, :text_en)");
                     
                      $smtp->bindParam(':icon', $_POST['icon']);
                ...
                if(isset($_POST['update'])){
                    ...
                    $smtp = $connection->prepare("UPDATE  `service` SET  icon=:icon , title_uz=:title_uz, title_en=:title_en, text_uz=:text_uz, text_en=:text_en WHERE id=:id");
  ...
  color: #888;
    ...
    <body>
        ...
        <main class="container section">
                    ...
                    <fieldset>
                        <input placeholder="Icon name" name="icon" value="<?php if($key == 1) echo $icon_ser?>" type="text" >
                    </fieldset>
                    <fieldset>
                        <input placeholder="Service Name uz" value="<?php if($key == 1) echo $title_uz_ser?>" type="text" tabindex="3" name="title_uz">
                    </fieldset>
                    <fieldset>
                    ...
                    <fieldset>
                        <input placeholder="Service Name en" type="text" tabindex="3" value="<?php if($key == 1) echo $title_en_ser?>" name="title_en">
                    </fieldset>
                    <fieldset>
