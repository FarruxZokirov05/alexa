<?php
  ...
  try{
    ...
    if(isset($_GET['delete'])){
      $smtp = $connection->prepare("DELETE FROM `alexa_form` WHERE  id=:id ");
    ...
    <body>
        ...
        <div class="table">
          <div class="table-header">
            ...
            <div class="header__item"><a id="losses" class="filter__link filter__link--number" href="#">Message</a></div>
                               ...
                               if($result->num_rows > 0){
                                        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                                                ...
                                                <div class="table-row">		
                                                  ...
                                                  <div class="table-data"><?=$row['message']?></div>
