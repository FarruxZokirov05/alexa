<?php
  ...
  try{
    ...
    if(isset($_GET['delete'])){
      $smtp = $connection->prepare("DELETE FROM `service` WHERE  id=:id ");
    ...
    <body>
        ...
        <div class="table">
          <div class="table-header">
            ...
            <div class="header__item"><a id="wins" class="filter__link filter__link--number" href="#">Icon</a></div>
                               ...
                               if($result->num_rows > 0){
                                        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                                                ...
                                                <div class="table-row">		
                                                  ...
                                                  <div class="table-data"><?=$row['icon']?></div>
                                                  <div class="table-data"><?=$row['title_uz']?></div>
                                                  <div class="table-data"><?=$row['text_uz']?></div>
